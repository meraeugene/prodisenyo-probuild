...
export default function ProjectWorkspaceSkeleton() {
  return <div role="status" aria-label="Loading project details" className="min-h-full space-y-5 bg-white px-4 py-5 sm:px-6 lg:px-8 lg:py-7">
    <div className="-mx-4 -mt-5 border-b border-slate-200 bg-white/95 px-4 py-3 sm:-mx-6 sm:px-6 lg:-mx-8 lg:-mt-7 lg:px-8"><Block className="h-5 w-36" /></div>

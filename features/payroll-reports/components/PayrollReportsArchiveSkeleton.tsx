...
export default function PayrollReportsArchiveSkeleton() {
  return <section aria-label="Loading payroll reports" className="rounded-2xl border border-apple-mist bg-white p-5 shadow-[0_10px_30px_rgba(7,109,105,0.07)] sm:p-6">

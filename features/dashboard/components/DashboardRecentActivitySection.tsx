...
export default function DashboardRecentActivitySection({
  ...
  return (
    <section className="rounded-[12px] bg-white p-5 shadow-[0_10px_30px_rgba(7,109,105,0.07)]">
      <div className="mb-4 flex flex-col items-start justify-between gap-2 sm:flex-row sm:items-center">
        <p className="text-[15px] font-semibold text-apple-charcoal">
          Recent Payroll Activity
        </p>
        <p className="text-xs text-teal-500">{attendancePeriod}</p>
      </div>

      <div className="overflow-hidden rounded-[12px] border border-apple-mist">
        <div className="overflow-x-auto">
          <div className="min-w-[640px]">
            <div className="grid grid-cols-[1fr_1.2fr_1fr_0.9fr_1fr] bg-[rgb(var(--apple-snow))] px-4 py-3 text-[10px] font-semibold uppercase tracking-[0.18em] text-teal-500">
              <span>Type</span>
              <span>Employee</span>
              <span>Amount</span>
              <span>Status</span>

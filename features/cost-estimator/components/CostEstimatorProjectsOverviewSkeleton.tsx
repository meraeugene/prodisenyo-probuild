...
export default function CostEstimatorProjectsOverviewSkeleton() {
  return (
    <div className="space-y-4 overflow-x-hidden p-0 sm:p-6">
      <section className="sm:rounded-[14px] bg-[linear-gradient(135deg,#112e1a,#1f4f2c,#245f34)] p-5 shadow-[0_18px_36px_rgba(22,101,52,0.18)] sm:p-6">
      ...
      <section className="sm:rounded-[18px] border border-apple-mist bg-white p-5 shadow-[0_10px_30px_rgba(24,83,43,0.06)]">

...
export default function OvertimeRejectedAlertModal({
  open,
  employeeName,
  siteName,
  periodLabel,
        ...
        <div className="grid gap-6 sm:grid-cols-[220px_minmax(0,1fr)] sm:items-center">
          ...
          <div>
            ...
            <p className="mt-3 text-sm leading-7 text-apple-steel">
              This overtime request needs revisions before it can be approved. Review the notes below,
              update the payroll entry, and submit it again when it is ready.
            </p>
          </div>
        </div>
        ...
        <div className="mt-6 rounded-[22px] border border-[#dceadb] bg-white/85 p-5">
          ...
          <p className="mt-2 text-sm leading-7 text-apple-charcoal">
            {rejectionReason?.trim() ||
              "No additional notes were provided, but this overtime request still needs updates before approval."}
          </p>
        </div>

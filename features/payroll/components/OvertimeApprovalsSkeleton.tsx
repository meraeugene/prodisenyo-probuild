...
export default function OvertimeApprovalsSkeleton() {
  return <div role="status" aria-label="Loading overtime approvals" className="min-h-full space-y-7 bg-white p-4 sm:p-6 lg:p-8">
    <header className="rounded-[22px] bg-[#075e5b] p-6 sm:p-9"><Block light className="h-3 w-32" /><Block light className="mt-3 h-9 w-80 sm:h-10" /><Block light className="mt-3 h-5 w-96 max-w-full" /></header>

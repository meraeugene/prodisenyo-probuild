      ...
      <div className="mt-4 min-h-0 flex-1 space-y-3 overflow-y-auto pr-1">
        {sortedRequests.length === 0 ? (
          ...
          sortedRequests.map((request) => (
            <article
              key={request.id}
              className="group flex h-fit w-full max-w-full flex-col rounded-2xl border border-apple-mist bg-[rgb(var(--apple-snow))] p-5 shadow-[0_8px_20px_rgba(24,83,43,0.04)] transition-all"
            >

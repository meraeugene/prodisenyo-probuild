...
export default async function LoginPage({
  ...
  return (
    <main className="relative min-h-screen sm:overflow-hidden bg-[radial-gradient(circle_at_top_left,rgba(174,220,188,0.34),transparent_30%),radial-gradient(circle_at_bottom_right,rgba(56,140,82,0.18),transparent_28%),linear-gradient(180deg,#f4fbf6_0%,#ffffff_46%,#f2faf5_100%)]">

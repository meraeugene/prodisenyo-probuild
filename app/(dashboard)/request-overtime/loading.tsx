  ...
  return (
    <div className="overflow-x-hidden p-0 sm:p-6 xl:flex xl:h-screen xl:flex-col xl:overflow-hidden">
      ...
      <div className="mt-4 grid gap-4 overflow-x-hidden xl:min-h-0 xl:flex-1 xl:grid-cols-[1.08fr_0.92fr] xl:items-stretch">
        <section className="rounded-[16px] border border-apple-mist bg-white p-5 shadow-[0_10px_30px_rgba(7,109,105,0.07)]">
        ...
        <section className="rounded-[16px] border border-apple-mist bg-white p-5 shadow-[0_10px_30px_rgba(7,109,105,0.07)] xl:flex xl:h-full xl:min-h-0 xl:flex-col">

...
export default function Loading() {
  return (
    <div className="space-y-4 overflow-x-hidden p-0 sm:p-6">
      <section className="rounded-none bg-[linear-gradient(135deg,#063b38,#075f5b,#087a75)] p-5 shadow-[0_18px_36px_rgba(7,109,105,0.18)] sm:rounded-[16px] sm:p-6">
      ...
      <section className="grid gap-4 2xl:grid-cols-[420px_minmax(0,1fr)]">
        <div className="rounded-none border border-apple-mist bg-white p-6 shadow-[0_10px_30px_rgba(7,109,105,0.06)] sm:rounded-[22px]">

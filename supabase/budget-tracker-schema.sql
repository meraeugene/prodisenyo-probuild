...
drop policy if exists "budget projects readable by payroll managers, engineers, and ceo" on public.budget_projects;
drop policy if exists "budget projects managed by payroll managers, engineers, and ceo" on public.budget_projects;
drop policy if exists "budget items readable by payroll managers, engineers, and ceo" on public.budget_items;
drop policy if exists "budget items managed by payroll managers, engineers, and ceo" on public.budget_items;
drop policy if exists "budget projects readable by all app roles" on public.budget_projects;
drop policy if exists "budget projects managed by all app roles" on public.budget_projects;
drop policy if exists "budget items readable by all app roles" on public.budget_items;
drop policy if exists "budget items managed by all app roles" on public.budget_items;

create policy "budget projects readable by all app roles"
